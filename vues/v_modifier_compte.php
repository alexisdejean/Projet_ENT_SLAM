...
<h2 style="text-align:center;background-color:white; border-radius:0.1em; padding-left:0.2em; margin-left:0.8em; padding-right:1em; width: 15em;"> Modification de ton compte, <?php echo htmlspecialchars($_SESSION['prenom']) ?> </h2>    
