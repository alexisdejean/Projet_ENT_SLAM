...
<div class="formulaire" style="float: left; margin-top: 12em; margin-left: 10em; text-align: center; color: white;">
    ...
    <form action="../index.php?uc=auth&action=connexion" method="post" class="form" style="background: linear-gradient(75deg, white, whitesmoke); border-radius: 15px; padding: 2em; margin-top: 0.1em; width: 20em; box-shadow: 6px 4px 4px black;">
        <input style="height: 2em;padding: 1em; background-color: rgba(217, 217, 217, 1); border:none; border-radius:0.5em;" type="text" placeholder="Login" name="pseudo" required><br><br>
        <input style="height: 2em; padding: 1em; background-color: rgba(217, 217, 217, 1); border:none; border-radius:0.5em;" type="password" placeholder="Mot de passe" name="mdp" required><br><br>
